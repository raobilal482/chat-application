						...
						<div class="card radius-15 w-100">
							<div class="card-body">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{asset('assets')}}/images/icons/chrome.png" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{asset('assets')}}/images/icons/firefox.png" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{asset('assets')}}/images/icons/edge.png" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{asset('assets')}}/images/icons/opera.png" width="35" height="35" alt="" />
									</div>
									<div class="">
								...
								<div class="d-flex align-items-center gap-3">
									<div>
										<img src="{{asset('assets')}}/images/icons/safari.png" width="35" height="35" alt="" />
									</div>
									<div class="">
